...
_PREFIXED = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='prefix', full_name='vlsir.utils.Prefixed.prefix', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='integer', full_name='vlsir.utils.Prefixed.integer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='double', full_name='vlsir.utils.Prefixed.double', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='string', full_name='vlsir.utils.Prefixed.string', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='number', full_name='vlsir.utils.Prefixed.number',
...
_PARAMVALUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='integer', full_name='vlsir.utils.ParamValue.integer', index=0,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='double', full_name='vlsir.utils.ParamValue.double', index=1,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='string', full_name='vlsir.utils.ParamValue.string', index=2,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='literal', full_name='vlsir.utils.ParamValue.literal', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='prefixed', full_name='vlsir.utils.ParamValue.prefixed', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='vlsir.utils.ParamValue.value',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_PARAM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='vlsir.utils.Param.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='vlsir.utils.Param.value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='desc', full_name='vlsir.utils.Param.desc', index=2,
...
_PREFIXED.oneofs_by_name['number'].fields.append(
  _PREFIXED.fields_by_name['integer'])
_PREFIXED.fields_by_name['integer'].containing_oneof = _PREFIXED.oneofs_by_name['number']
_PREFIXED.oneofs_by_name['number'].fields.append(
  _PREFIXED.fields_by_name['double'])
_PREFIXED.fields_by_name['double'].containing_oneof = _PREFIXED.oneofs_by_name['number']
_PREFIXED.oneofs_by_name['number'].fields.append(
  _PREFIXED.fields_by_name['string'])
...
_PARAMVALUE.oneofs_by_name['value'].fields.append(
  _PARAMVALUE.fields_by_name['integer'])
_PARAMVALUE.fields_by_name['integer'].containing_oneof = _PARAMVALUE.oneofs_by_name['value']
_PARAMVALUE.oneofs_by_name['value'].fields.append(
  _PARAMVALUE.fields_by_name['double'])
_PARAMVALUE.fields_by_name['double'].containing_oneof = _PARAMVALUE.oneofs_by_name['value']
_PARAMVALUE.oneofs_by_name['value'].fields.append(
  _PARAMVALUE.fields_by_name['string'])
_PARAMVALUE.fields_by_name['string'].containing_oneof = _PARAMVALUE.oneofs_by_name['value']
_PARAMVALUE.oneofs_by_name['value'].fields.append(
  _PARAMVALUE.fields_by_name['literal'])
_PARAMVALUE.fields_by_name['literal'].containing_oneof = _PARAMVALUE.oneofs_by_name['value']
_PARAMVALUE.oneofs_by_name['value'].fields.append(
  _PARAMVALUE.fields_by_name['prefixed'])
_PARAMVALUE.fields_by_name['prefixed'].containing_oneof = _PARAMVALUE.oneofs_by_name['value']
...
Prefixed = _reflection.GeneratedProtocolMessageType('Prefixed', (_message.Message,), {
